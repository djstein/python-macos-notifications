# Documentation for MacOS Notification can be found here: https://developer.apple.com/documentation/foundation/notifications
# Before running please pip install pyobjc 
# Solution based on https://stackoverflow.com/questions/15896348/nsusernotificationcenter-not-showing-notifications
...
class MacOSNotification(NSObject):
    ...
    def clearNotifications(self):
        self.NSUserNotificationCenter.defaultUserNotificationCenter().removeAllDeliveredNotifications()
    ...
    def notify(self, display_information={}, displayed_notification_buttons={}):
        ...
        if 'informative_text' in display_information:
            notification.setInformativeText_(str(display_information['informative_text']))
...
def main():
    ...
    notification = mac_os_notification.notify(display_information=display_information, displayed_notification_buttons=displayed_notification_buttons)
